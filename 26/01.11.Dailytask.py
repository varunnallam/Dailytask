...
class Person:
    def __init__(self, name, age, gender, Roll_no, block_no, phone_no):
        self.name = name
        self.age = age
        self.gender = gender
...
for i in range(1):  
    ...
    block_no = input("Enter your block_no: ")
    phone_no = int(input("Enter your phone_no: "))
   
    person = Person(name, age, gender, Roll_no, block_no, phone_no)
    p.append(person)  
