...
tr=teachingresearcher("math","hindi")  
...
e = Employee("munna", 230000)
d = Developer("kanna", 30000, "sap")
m = Manager("Ram", 80000, 10)
i = Intern("sita", 20000, "abap", 6)
...
car = Car("suzuki", "800", 4)
 
bike = Bike("Yamaha", "RX100", "Sport")
...
phone = Phone("vivo", "123-456-7890")
tablet = Tablet("Samsung Galaxy Tab", 10.1)
smartphone = Smartphone("iPhone", "987-654-3210", 6.1, "iOS")
